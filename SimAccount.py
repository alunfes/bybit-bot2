...
class SimAccount:
    ...
    @classmethod
    def update_order_data(cls, side, price, size, leaves_qty, cum_exec_fee, status):
        with cls.lock_order:
            cls.order_side = side
            cls.order_price = price
            cls.order_size = size
            cls.order_leaves_qty = leaves_qty
            cls.order_cum_exec_fee = cum_exec_fee
            cls.order_status = status
